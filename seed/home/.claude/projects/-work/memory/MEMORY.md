...
- [hizi-card watcher](project_hizi_card_watcher.md) — @claude mentions on the hizi card table trigger /hizi-card via `bc-watcher` tmux session; restart it after container reboot
